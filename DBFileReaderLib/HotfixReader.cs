...
namespace DBFileReaderLib
{
    public class HotfixReader
    {
        ...
        public void ApplyHotfixes<T>(IDictionary<int, T> storage, DBParser dbReader, RowProcessor processor) where T : class, new()
        ...
        protected virtual void ReadHotfixes<T>(IDictionary<int, T> storage, DBParser dbReader, RowProcessor processor = null) where T : class, new()
        {
